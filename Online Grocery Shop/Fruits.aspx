<%@ Page Title="" Language="C#" MasterPageFile="~/GrocerySite.master" AutoEventWireup="true" CodeFile="Fruits.aspx.cs" Inherits="Fruits" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="float: left; width: 120px">
        <fieldset class="fieldsetmain">
            <legend style="font-size: 20px;">Fruits</legend>
